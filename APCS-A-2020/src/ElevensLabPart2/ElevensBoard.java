			...
			for (int i = 0; i < selectedCards.size(); i++) {
				for (int j = 0; j < selectedCards.size(); j++) {
					for (int k = 0; k < selectedCards.size(); k++) {
						if (this.cardAt(selectedCards.get(i)).rank() == "jack" && this.cardAt(selectedCards.get(j)).rank() == "queen"
								&& this.cardAt(selectedCards.get(k)).rank() == "king")
							return true;
						if (this.cardAt(selectedCards.get(i)).rank() == "jack" && this.cardAt(selectedCards.get(j)).rank() == "king"
								&& this.cardAt(selectedCards.get(k)).rank() == "queen")
							return true;
						if (this.cardAt(selectedCards.get(i)).rank() == "queen" && this.cardAt(selectedCards.get(j)).rank() == "jack"
								&& this.cardAt(selectedCards.get(k)).rank() == "king")
							return true;
						if (this.cardAt(selectedCards.get(i)).rank() == "queen" && this.cardAt(selectedCards.get(j)).rank() == "king"
								&& this.cardAt(selectedCards.get(k)).rank() == "jack")
							return true;
						if (this.cardAt(selectedCards.get(i)).rank() == "king" && this.cardAt(selectedCards.get(j)).rank() == "jack"
								&& this.cardAt(selectedCards.get(k)).rank() == "queen")
							return true;
						if (this.cardAt(selectedCards.get(i)).rank() == "king" && this.cardAt(selectedCards.get(i)).rank() == "queen"
								&& this.cardAt(selectedCards.get(k)).rank() == "jack")
							return true;
					}
				}
